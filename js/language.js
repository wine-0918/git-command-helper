...
const languages = {
    ja: {
        ...
        data: {
            ...
            back: '戻る',
            contact_description: 'ご質問やご要望がございましたら、お気軽にお問い合わせください。',
            name: 'お名前',
            email: 'メールアドレス',
            message: 'メッセージ',
            send: '送信',
            ...
            view_all_updates: 'すべての更新履歴を見る',
            update_history_subtitle: '詳細な更新履歴・変更ログ',
    ...
    en: {
        ...
        data: {
            ...
            retry_send: 'Retry',
            contact_success: 'Your inquiry has been sent! We have also sent you a confirmation email.',
            ...
            view_all_updates: 'View All Update History',
            update_history_subtitle: 'Detailed update history & changelog',
    ...
    zh: {
        ...
        data: {
            ...
            view_all_updates: '查看所有更新历史',
            update_history_subtitle: '详细更新历史・变更日志',
            name_placeholder: '姓名',
